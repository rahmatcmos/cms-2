<template>
  <div class="row">
    ...
    <div class="col-md-8 col-sm-12 col-xs-12" v-if="mediaDetail">
      <div class="x_panel">
        <div class="x_title">
          ...
          <ul class="nav navbar-right panel_toolbox">
            ...
            <li><a class="close-link" v-on:click="fetchCategory"><i class="fa fa-close"></i></a>
            </li>
          </ul>
          <div class="clearfix"></div>
        </div>
    ...
    <div class="col-md-8 col-sm-12 col-xs-12" v-if="!mediaDetail">
      <div class="x_panel">
        <div class="x_title">
          <h2>Menu Tables <small>total media  <span>{{ total }}</span></small></h2>
          <ul class="nav navbar-right panel_toolbox">
            <li><a class="collapse-link"><i class="fa fa-plus"></i></a>
            </li>
            <li><a class="close-link"><i class="fa fa-close"></i></a>
