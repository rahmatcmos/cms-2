      ...
      <div class="x_panel">
        ...
        <div class="x_content">
          ...
          <table class="table">
            ...
            <tbody>
              <tr v-for="(index, p) in posts">
                <th scope="row"><a href="javascript:void(0)" name="Edit" v-on:click="btnEditPost(index)" >{{ index+1 }}</a></th>
                <td><a href="javascript:void(0)" name="Edit" v-on:click="btnEditPost(index)" >{{ p.title}}</a></td>
    ...
    methods: {
        ...
        fetchPost: function() {
            ...
            this.$http.get(this.url + this.segUrl).then((response) => {
              ...
              //  this.allPost = response.data.all
